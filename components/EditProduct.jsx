...
export default function EditProduct({ productId, onBack }) {
  ...
  // 🔧 OPTIMIZATION: Barcode scanner performance - debounced input
  ...
  // 🔧 OPTIMIZATION: Handle barcode input with debouncing for scanner performance
  const handleBarcodeChange = (e) => {
    ...
    // Update form only after 300ms of no input (scanner is done typing)
    ...
    const loadInitialData = async () => {
      ...
      try {
        ...
        if (productId) {
          ...
          // 🔧 OPTIMIZATION: Initialize barcode debounced state
